...
export const useFilters = (
    ...
    // 3. Dropdown Options
    // ⚡ Bolt Performance Optimization: Replace chained array operations (.filter, .map)
    // with single-pass loops to avoid redundant memory allocations and reduce GC overhead.
