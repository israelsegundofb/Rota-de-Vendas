...
export const useFilters = (
    ...
    const filteredClients = useMemo(() => {
        ...
        // Optimize: Pre-compile case-insensitive RegExp objects for text search in hot loops.
        // This avoids creating new string allocations (.toLowerCase()) in memory for every iteration,
        // significantly reducing garbage collection overhead.
        ...
        const prodQueryRegex = new RegExp(escapedProdQuery, 'i');
        const isProdSearchEmpty = !(debouncedProductQuery || '');
        ...
        return visibleClients.filter(c => {
            ...
            if (filterProductCategory !== 'Todos' || filterProductSection !== 'Todas' || filterProductSku !== 'Todos' || !isProdSearchEmpty) {
                ...
                if (!c.purchasedProducts || c.purchasedProducts.length === 0) {
                    ...
                    let hasMatch = isProdSearchEmpty;
