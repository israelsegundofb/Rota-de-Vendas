    ...
    return (
        <div className="relative inline-block" ref={containerRef}>
          ...
          ${isOpen ? 'bg-primary-container border-primary text-on-primary-container shadow-sm' :
            ...
            {/* Popover - MD3 Style */}
            {isOpen && (
                <div className="absolute top-full left-0 mt-2 z-[9999] bg-white border border-outline-variant rounded-2xl shadow-elevation-3 p-4 min-w-[280px] sm:min-w-[320px] animate-in fade-in slide-in-from-top-2 duration-200">
                    {/* Header */}
