...
const ChatPanel: React.FC<ChatPanelProps> = ({
    ...
    // ⚡ Bolt: Memoize filtered messages to prevent O(N) recalculations on every keystroke in the chat input
    ...
    }, [messages, activeUserId, currentUser.role, currentUser.id]);

    // ⚡ Bolt: Memoize filtered users to prevent string manipulation and filtering on every re-render
